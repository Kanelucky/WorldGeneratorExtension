            ...
            for (Position pos : between(placePos.add(-16, -16, -16), placePos.add(16, 16, 16))) {
                ...
                if (!(pointOffset < outerLayer)) {
                    if (generateCrack && crackOffset >= crackSize && pointOffset < filling) {
                        level.setBlockAtLayer((int) pos.x, (int) pos.y, (int) pos.z, BlockLayer.NORMAL.ordinal(), Block.AIR);
                        level.setBlockAtLayer((int) pos.x, (int) pos.y, (int) pos.z, BlockLayer.WATERLOGGED.ordinal(), Block.AIR);
                        ...
                        if (useAlternateLayer0) {
                            level.setBlockAtLayer((int) pos.x, (int) pos.y, (int) pos.z, BlockLayer.NORMAL.ordinal(), Block.AMETHYST_BLOCK);
                            level.setBlockAtLayer((int) pos.x, (int) pos.y, (int) pos.z, BlockLayer.WATERLOGGED.ordinal(), Block.AIR);
                        } else {
                            level.setBlockAtLayer((int) pos.x, (int) pos.y, (int) pos.z, BlockLayer.NORMAL.ordinal(), Block.BUDDING_AMETHYST);
                            level.setBlockAtLayer((int) pos.x, (int) pos.y, (int) pos.z, BlockLayer.WATERLOGGED.ordinal(), Block.AIR);
                        }
                        ...
                        level.setBlockAtLayer((int) pos.x, (int) pos.y, (int) pos.z, BlockLayer.NORMAL.ordinal(), Block.CALCITE);
                        level.setBlockAtLayer((int) pos.x, (int) pos.y, (int) pos.z, BlockLayer.WATERLOGGED.ordinal(), Block.AIR);
                    } else if (pointOffset >= outerLayer) {
                        level.setBlockAtLayer((int) pos.x, (int) pos.y, (int) pos.z, BlockLayer.NORMAL.ordinal(), Block.SMOOTH_BASALT);
                        level.setBlockAtLayer((int) pos.x, (int) pos.y, (int) pos.z, BlockLayer.WATERLOGGED.ordinal(), Block.AIR);
                    }
                }
            }
            ...
            for (Position potentialPos : potentialPlacements) {
                ...
                for (BlockFace direction : BlockFace.values()) {
                    ...
                    if (level.getBlockIdAt((int) side.x, (int) side.y, (int) side.z) == Block.AIR) {
                        ...
                        level.setBlockAtLayer((int) side.x, (int) side.y, (int) side.z, BlockLayer.NORMAL.ordinal(), amethyst.getId(), amethyst.getDamage());
                        level.setBlockAtLayer((int) side.x, (int) side.y, (int) side.z, BlockLayer.WATERLOGGED.ordinal(), Block.AIR);
                        break;
                    }
                }
            }
